...
export default function Page() {
  return (
    <div>
      <div className={"mb-6"}>
        <h1 className={"text-xl font-bold text-foreground"}>JMR & Field Reports</h1>
        <p className={"text-sm text-muted-foreground mt-0.5"}>JMR, FIM, Conjunction and LMC uploads. (Module 11)</p>
      </div>
