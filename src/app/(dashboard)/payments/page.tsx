...
export default function Page() {
  return (
    <div>
      <div className={"mb-6"}>
        <h1 className={"text-xl font-bold text-foreground"}>Payments & Expenses</h1>
        <p className={"text-sm text-muted-foreground mt-0.5"}>Worker payments, advances and expense tracking. (Module 14)</p>
      </div>
