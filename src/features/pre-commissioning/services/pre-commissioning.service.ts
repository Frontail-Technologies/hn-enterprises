...
export const preCommissioningRecords: PreCommissioningRecord[] = [
  {
    ...
    customerMobile: "9823411122",
    evidenceCount: 3,
    purgingDate: "2025-02-18 09:20",
    purgingPressure: "110 mbar",
    purgingDuration: "35 minutes",
    purgingRemarks: "Purging completed with stable pressure and clear odorant confirmation.",
    locationSection: "Block A / Domestic riser section",
    pipeLengths: "20MM: 42 m, 32MM: 18 m",
    valveChambers: "Isolation: 2, Service: 1",
  ...
  },
  {
    ...
    customerMobile: "9876501122",
    evidenceCount: 4,
    purgingDate: "2025-02-17 12:15",
    purgingPressure: "105 mbar",
    purgingDuration: "30 minutes",
    purgingRemarks: "Purging readings accepted for commissioning readiness.",
    locationSection: "Block B / Lane 3 service section",
    pipeLengths: "20MM: 36 m, 32MM: 12 m",
    valveChambers: "Isolation: 1, Service: 1",
  ...
  },
  {
    ...
    customerMobile: "9900112255",
    evidenceCount: 2,
    purgingDate: "2025-02-15 08:50",
    purgingPressure: "98 mbar",
    purgingDuration: "25 minutes",
    purgingRemarks: "Pressure verification photo needs correction before approval.",
    locationSection: "Commercial Block / Meter bank section",
    pipeLengths: "32MM: 28 m, 63MM: 10 m",
    valveChambers: "Isolation: 2, PRS: 1",
...
export const preCommissioningEvidence: PreCommissioningEvidence[] = [
  {
    ...
    remarks: "Meter and regulator placement clearly visible.",
  },
  {
    id: "pc-ev-2",
    ...
    remarks: "Reading is visible; awaiting reviewer confirmation.",
  },
  {
    id: "pc-ev-3",
    ...
    remarks: "Signed safety verification report attached.",
  },
];
